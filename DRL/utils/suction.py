...
class Suction(Gripper):
  ...
  def __init__(self, robot, ee, obj_ids):
    ...
    pybullet.changeConstraint(constraint_id, maxForce=500) #Force to attach suction to end joint of robot
    pybullet.changeDynamics(self.body, -1, lateralFriction=1.0, contactStiffness=1e6,
                            contactDamping=0.1)  # Added for contact sensitivity, making the suction tip’s contacts harder and more detectable with minimal penetration
